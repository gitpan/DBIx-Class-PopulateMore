package #hide from pause
 DBIx::Class::PopulateMore::Test::Schema::Result::Gender;

use base 'DBIx::Class::PopulateMore::Test::Schema::Result';

=head1 NAME

DBIx::Class::PopulateMore::Test::Schema::Result::Gender; A Gender Class;
...
__PACKAGE__
    ->has_many(
        people => 'DBIx::Class::PopulateMore::Test::Schema::Result::Person', 
