package #hide from pause
 DBIx::Class::PopulateMore::Test::Schema::Result::CompanyPerson;
...
__PACKAGE__
    ->belongs_to( employee => 'DBIx::Class::PopulateMore::Test::Schema::Result::Person', {
...
__PACKAGE__
    ->belongs_to( company => 'DBIx::Class::PopulateMore::Test::Schema::Result::Company', { 
...
__PACKAGE__
	->has_one (employment_history => 'DBIx::Class::PopulateMore::Test::Schema::Result::EmploymentHistory', {
