package #hide from pause
 DBIx::Class::PopulateMore::Test::Schema::Result::FriendList;

use base 'DBIx::Class::PopulateMore::Test::Schema::Result';

=head1 NAME

DBIx::Class::PopulateMore::Test::Schema::Result::FriendList - An example Friends Class;
...
__PACKAGE__
    ->belongs_to( befriender => 'DBIx::Class::PopulateMore::Test::Schema::Result::Person', {
...
__PACKAGE__
    ->belongs_to( friendee => 'DBIx::Class::PopulateMore::Test::Schema::Result::Person', { 
