package #hide from pause
 DBIx::Class::PopulateMore::Test::Schema::Result::Person;

use base 'DBIx::Class::PopulateMore::Test::Schema::Result';

=head1 NAME

DBIx::Class::PopulateMore::Test::Schema::Result::Person - A Person Class
...
__PACKAGE__
    ->has_many( 
        friendlist => 'DBIx::Class::PopulateMore::Test::Schema::Result::FriendList',
...
__PACKAGE__
    ->belongs_to( gender => 'DBIx::Class::PopulateMore::Test::Schema::Result::Gender', { 
...
__PACKAGE__
    ->belongs_to( fanlist => 'DBIx::Class::PopulateMore::Test::Schema::Result::FriendList', { 
...
__PACKAGE__
    ->has_many( 
        companies_person => 'DBIx::Class::PopulateMore::Test::Schema::Result::CompanyPerson',
        {'foreign.fk_person_id' => 'self.person_id'});
