package DBIx::Class::PopulateMore;

use warnings;
use strict;

use DBIx::Class::PopulateMore::Command;

=head1 NAME

DBIx::Class::PopulateMore - An enhanced populate method
...
This distribution supplies three commands:
...
sub populate_more
{
	...
	if( my $arg = shift @_)
	{
		if( ref $arg eq 'ARRAY')
		{
			DBIx::Class::PopulateMore::Command
				->new(
					definitions=>$arg,
					schema=>$self )
				->execute;			
...
Please report any bugs or feature requests to:
	...
	C<bug-dbix-class-populatemore at rt.cpan.org>

or through the web interface at:

	L<http://rt.cpan.org/NoAuth/ReportBug.html?Queue=DBIx-Class-PopulateMore>
...
L<http://rt.cpan.org/NoAuth/Bugs.html?Dist=DBIx-Class-PopulateMore>

=item * AnnoCPAN: Annotated CPAN documentation

L<http://annocpan.org/dist/DBIx-Class-PopulateMore>

=item * CPAN Ratings

L<http://cpanratings.perl.org/d/DBIx-Class-PopulateMore>
